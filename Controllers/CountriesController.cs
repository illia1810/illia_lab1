...
namespace LaptopProject.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public CountriesController(LaptopBaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Index", "Laptops", new { country_id = country.Id});
        }
        ...
        {
            var lap = _context.Laptop.Where(l => l.CountryId == id).Include(l => l.Color).Include(l => l.Cpu).Include(l => l.Model).ToList();
